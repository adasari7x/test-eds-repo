...
## Environments
- Preview: https://main--test-eds-repo--adasari7x.aem.page/
- Live: https://main--test-eds-repo--adasari7x.aem.live/
...
1. Open the `test-eds-repo` directory in your favorite IDE and start coding :)
